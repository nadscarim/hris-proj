...
const EmployeeLayout = () => {
    ...
    const timeInOut = async (type) => {
        let response = await axios.post('/timeInOut', {type})
        ...
        <>
            <Layout className='body'>
                ...
                <div className="site-card-wrapper">
                    ...
                    <Col span={24}>
                        <Card bordered={false}>
                            <Button onClick={() => timeInOut('time_in')} type="primary">Time-In</Button>
                            <Button onClick={() => timeInOut('time_out')} type="danger">Time-Out</Button>
